...
1030 IF KEY$="ArrowLeft"  THEN gosub clearcursor: cX=cX-1: cX=RANGE( cX,0,sw-1 ) : gosub drawcursor  : goto paint
1035 IF KEY$="ArrowRight" THEN gosub clearcursor: cX=cX+1: cX=RANGE( cX,0,sw-1 ) : gosub drawcursor  : goto paint

1040 IF KEY$="8"  THEN gosub scrollup: gosub drawpic : goto paint
1045 IF KEY$="4"  THEN gosub scrollleft: gosub drawpic : goto paint
1050 IF KEY$="6"  THEN gosub scrollright: gosub drawpic : goto paint
1055 IF KEY$="2"  THEN gosub scrolldown: gosub drawpic : goto paint
...
13010 out$ = (cx+1) ; ", " ; (cy+1) ; chr$( 10 )
13020 for y=0 to cy: for x=0 to cx
...
15000 sub scrollleft
15020 for y=0 to sh-1: for x=0 to sw-2
15040 pic(x,y,0) = pic(x+1,y,0)
15041 pic(x,y,1) = pic(x+1,y,1)
15042 pic(x,y,2) = pic(x+1,y,2)
15050 next
15060 next
15070 for y=0 to sh-1: pic(sw-1,y,0)=32: pic(sw-1,y,2)=0: next
15080 return

15100 sub scrollup
15120 for y=0 to sh-2: for x=0 to sw-1
15140 pic(x,y,0) = pic(x,y+1,0)
15141 pic(x,y,1) = pic(x,y+1,1)
15142 pic(x,y,2) = pic(x,y+1,2)
15150 next
15160 next
15170 return

15200 sub scrollright
15220 for y=0 to sh-1: for x=sw-1 to 1 step -1
15240 pic(x,y,0) = pic(x-1,y,0)
15241 pic(x,y,1) = pic(x-1,y,1)
15242 pic(x,y,2) = pic(x-1,y,2)
15250 next
15260 next
15270 for y=0 to sh-1: pic(0,y,0)=32: pic(0,y,2)=0: next
15280 return

15300 sub scrolldown
15320 for y=sh-1 to 1 step -1: for x=0 to sw-1
15340 pic(x,y,0) = pic(x,y-1,0)
15341 pic(x,y,1) = pic(x,y-1,1)
15342 pic(x,y,2) = pic(x,y-1,2)
15350 next
15360 next
15370 return
